export const projectsData = [
  {
    title: "Viva Aqua",
    description: "Winner of NASA Pale Blue Dot Internationam Competition 2024. An open-source machine learning tool for groundwater monitoring using NASA datasets.",
    images: [
      "/Viva_4.png",
      "/Viva_2.jpg",
      "/Viva_3.jpg",
    ...
    tags: ["Machine Learning", "NASA Datasets", "Groundwater"],
    links: { demo: "#", github: "https://github.com/Maal1ck" }
  },
  {
    title: "WaterWatch Africa",
    description: "Built a tool that helps track water quality using satellite imagery and spectral indices.",
    images: [
      "/Waterwatch_1.png",
      "/Waterwatch_2.png",
      "/Waterwatch_3.png"
    ],
    tags: ["Remote Sensing", "Spectral Indices", "Water Quality"],
    links: { demo: "#", github: "https://github.com/Maal1ck" }
  },
  {
    title: "Sun Agri Access",
    description: "A web GIS tool designed to support optimal solar panel sizing for sustainable agriculture applications.",
    images: [
      "/SunAgri_1.png",
      "/SunAgri_2.png"
    ],
    tags: ["Web GIS", "Renewable Energy", "Sustainable Ag"],
    links: { demo: "#", github: "https://github.com/Maal1ck" }
  },
  {
